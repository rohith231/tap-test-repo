    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card card-top card-top-primary">
          ...
          <div class="card-body">
            <vb-forms-device :data="{ device_id }" :disabled="disabled" />
          </div>
...
import VbFormsDevice from '@/@vb/widgets/Forms/device'
...
export default {
  ...
  data() {
    ...
    let title = computed(() => routeDetails.value.params.id == 'new' ?  'New Target' :  'Target details')
    let device_id = computed(() => routeDetails.value.params.id)
