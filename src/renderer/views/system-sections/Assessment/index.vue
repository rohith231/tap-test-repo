...
export default {
  ...
  setup() {
    ...
    let data = computed(() => store.getters['assessments/assessments'].list_framework)
    const total = computed(() => store.getters['assessments/assessments'].count_framework)
    ...
    const getData = () => {
      store.dispatch('assessments/GET_SUB', {
        payload: {
