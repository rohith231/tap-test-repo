    ...
    watch(GET_CHARTS_COMPLIANCE_CONTROLLERS, (GET_CHARTS_COMPLIANCE_CONTROLLERS) => {
      const chartData = {
        datasets: [
          {
            data: [
              GET_CHARTS_COMPLIANCE_CONTROLLERS.num_of_COMPLIANT,
              GET_CHARTS_COMPLIANCE_CONTROLLERS.num_of_NONCOMPLIANT,
              GET_CHARTS_COMPLIANCE_CONTROLLERS.num_of_WAITING,
            ],
      ...
      if (this.isNoData(chartData.datasets[0].data)) {
        ...
        //     display: true,
        //     color: '#666666',
        //     formatter: () => 'NO DATA', // Customize the displayed text
        //   },
        // };
