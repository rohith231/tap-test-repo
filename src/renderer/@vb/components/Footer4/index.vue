<template>
  <div
    :class="{
      ...
      [$style.footerFullWidth]: !applicationSettings.isContentMaxWidth,
    }"
  >
      ...
      <div :class="$style.container">
        <div class="d-sm-flex align-items-sm-center">
          <div class="clearfix mr-sm-auto" :class="$style.logo">
            ...
            <div :class="$style.logo__name">{{ applicationSettings.masterName }}</div>
            <div :class="$style.logo__descr">{{ applicationSettings.version }}</div>
          </div>
