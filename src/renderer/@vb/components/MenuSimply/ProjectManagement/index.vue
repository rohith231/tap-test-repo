<template>
  <a-dropdown :trigger="['click']" placement="bottomLeft">
    <div :class="[$style.dropdown, $style.header_btn_type2]">
    ...
    <template #overlay>
      <a-menu>
        <a-menu-item-group title="Setup">
          <!-- <router-link to="/auth/database" :class="$style.breadcrumbLink"> -->
        ...
        <a-menu-item-group title="System Optimization">
          <!-- <a-menu-item @click="()=>console.log('ss')">
        ...
        <a-menu-divider />
        <!-- <router-link to="/settings" :class="$style.breadcrumbLink"> -->
