            ...
            <div class="row">
              <div class="col-lg-4">
                ...
                <div :class="$style.resultContent">
                  ...
                  <div :class="$style.result">
                    <div :class="$style.resultText">AC-16</div>
                    <div :class="$style.resultSource">In some partition</div>
                  </div>
                </div>
                <div :class="$style.resultContent">
              ...
              <div class="col-lg-4">
                <div :class="$style.resultContent">
                  ...
                  <div :class="$style.result">
                    <div :class="$style.resultText">User</div>
                    <div :class="$style.resultSource">In some partition</div>
                  </div>
                </div>
                <div :class="$style.resultContent">
                  ...
                  <div :class="$style.result">
                    <div :class="$style.resultText">NIST 800-53 r4</div>
                    <div :class="$style.resultSource">In some partition</div>
                  </div>
                </div>
                <div :class="$style.resultContent">
                  ...
                  <div :class="$style.result">
                    <div :class="$style.resultText">NIST 800-171 r2</div>
                    <div :class="$style.resultSource">In some partition</div>
                  </div>
                </div>
                <div :class="$style.resultContent">
                  <div :class="$style.resultThumb">04</div>
                  <div :class="$style.result">
                    <div :class="$style.resultText">NIST 800-53 r5</div>
                    <div :class="$style.resultSource">In some partition</div>
                  </div>
                </div>
              </div>
