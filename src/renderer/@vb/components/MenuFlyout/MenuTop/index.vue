  ...
  <div>
      ...
      <template v-for="(item, index) in renderedFlyoutItems" :key="index">
        <div
          ...
          :class="{
            ...
            [$style.air__menuFlyoutTop]: applicationSettings.menuLayoutType === 'top',
            [$style.air__menuFlyout__black]: applicationSettings.flyoutMenuColor === 'dark',
            [$style.air__menuFlyout__white]: applicationSettings.flyoutMenuColor === 'white',
            [$style.air__menuFlyout__gray]: applicationSettings.flyoutMenuColor === 'gray',
          }"
        >
          <ul
    ...
    <div
      :class="{
        ...
        [$style.air__menuTop__mobileToggled]: applicationSettings.isMobileMenuOpen,
        [$style.air__menuTop__toggled]: applicationSettings.isMenuCollapsed,
        [$style.air__menuTop__unfixed]: applicationSettings.isMenuUnfixed,
        [$style.air__menuTop__shadow]: applicationSettings.isMenuShadow,
        [$style.air__menuTop__flyout]: applicationSettings.menuType === 'flyout',
        [$style.air__menuTop__compact]: applicationSettings.menuType === 'compact',
        [$style.air__menuTop__blue]: applicationSettings.menuColor === 'blue',
        [$style.air__menuTop__white]: applicationSettings.menuColor === 'white',
        [$style.air__menuTop__gray]: applicationSettings.menuColor === 'gray',
        [$style.air__menuFlyout__black]:
          applicationSettings.flyoutMenuColor === 'dark' && applicationSettings.menuType !== 'default',
        [$style.air__menuFlyout__white]:
          applicationSettings.flyoutMenuColor === 'white' && applicationSettings.menuType !== 'default',
        [$style.air__menuFlyout__gray]:
          applicationSettings.flyoutMenuColor === 'gray' && applicationSettings.menuType !== 'default',
      }"
    >
...
export default {
  ...
  setup() {
    ...
    const flyoutActive = computed(() => {
      return !applicationSettings.value.isMobileView
    })
