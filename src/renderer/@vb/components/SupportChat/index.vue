<template>
  <div :class="$style.chat">
    ...
    >
      <i :class="$style.icon" class="lnr lnr-bullhorn mr-md-2" />
      <span class="d-none d-md-inline">Push Notifications</span>
    </a> -->
    <!-- <div
      :class="{
        [$style.container]: true,
        [$style.containerToggled]: applicationSettings.isSupportChatOpen,
      }"
    >
