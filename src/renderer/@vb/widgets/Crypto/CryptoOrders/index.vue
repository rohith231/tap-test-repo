      ...
      <div class="col-md-4">
        <div :class="$style.form">
          <a-form layout="vertical">
            <a-form-item>
              <a-radio-group default-value="buy" style="width: 100% !important" @change="toggleOrderType">
            ...
            <div v-if="orderType === 'buy'">
              ...
              <button class="btn btn-success" type="button" style="width: 100% !important">
            ...
            <div v-if="orderType === 'sell'">
              ...
              <button class="btn btn-danger" type="button" style="width: 100% !important">
