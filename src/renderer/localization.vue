...
export default {
  ...
  setup() {
    try {
      ...
      const settingsLocale = computed(() => store.state.applicationSettings.locale)
      // console.log(settingsLocale.value)
      const localeAntd = ref(locales[settingsLocale.value].locales)
