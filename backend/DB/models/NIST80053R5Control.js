module.exports = (db, DataTypes) => {
    const NIST80053R5Control = db.define('NIST80053R5Control', {
        id: {
          type: DataTypes.UUID,
      ...
      },
      {
        ...
        paranoid: true,
        timestamps: true,
        tableName: 'nist_800_53_r5_controls'
      }
    );
  
    NIST80053R5Control.associate = (models) => {
      NIST80053R5Control.hasOne(models.NIST80053R5CheckControl, {
    ...
    NIST80053R5Control.addHook('beforeBulkDestroy', (options) => {
      if (options.where.id) {
        // const models = require("./index");
        // models.NIST80053R5CheckControl.destroy({
        //   where: {
