...
module.exports = (sequelize, DataTypes) => {
  const NIST80053R4CheckControl = sequelize.define('NIST80053R4CheckControl', {
    id: {
      type: DataTypes.UUID,
    ...
    timestamps: true,
    paranoid: true,
    tableName: 'nist_800_53_r4_check_controls'
  });

  NIST80053R4CheckControl.associate = (models) => {
    NIST80053R4CheckControl.belongsTo(models.User, {
      foreignKey: 'user_id',
    });
    NIST80053R4CheckControl.belongsTo(models.System, {
      foreignKey: 'system_id',
    });
    NIST80053R4CheckControl.belongsTo(models.NIST80053R4Control, {
      foreignKey: 'control_number',
      targetKey: 'number',
      constraints: false
    });

    NIST80053R4CheckControl.hasMany(models.Poam, {
      foreignKey: 'control_id',
      sourceKey: 'id',
      onDelete: 'cascade',
      hooks: true,
    })
    NIST80053R4CheckControl.hasMany(models.Validation, {
      foreignKey: 'control_id',
      sourceKey: 'id',
      onDelete: 'cascade',
      hooks: true,
    ...
    NIST80053R4CheckControl.belongsToMany(models.Device, {
    ...
    NIST80053R4CheckControl.hasMany(models.AuditControl, {
  ...
  NIST80053R4CheckControl.addHook('beforeBulkDestroy', (options) => {
    if (options.where.id) {
  ...
  NIST80053R4CheckControl.scopes = (models) => {
    NIST80053R4CheckControl.addScope('defaultScope', {
      include: [{
        model: models.Poam
      }]
    });
  ...
  return NIST80053R4CheckControl;
};
